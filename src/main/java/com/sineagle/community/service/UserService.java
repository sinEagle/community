package com.sineagle.community.service;
...
import com.sineagle.community.util.RedisKeyUtil;
...
public class UserService implements CommunityConstant {
    ...
    public Map<String, Object> register(User user) {
        ...
        if (u != null) {
            map.put("mailMsg", "该邮箱已经被注册！");
            System.out.println("该邮箱已经被注册！该邮箱已经被注册！该邮箱已经被注册！！！！");
            return map;
        }
        ...
        // https://localhost:8080/communtiy/activation/id/code
